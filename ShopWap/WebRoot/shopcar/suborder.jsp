			...
			<div class="new-pay-pw">   		
				<div class="new-set-info">
					...
					<span class="new-input-span new-input-span-v1 new-mg-b10">
						<input class="new-input" type="text" id="name" name="name"  placeholder="收货人姓名" />
						<span  id="second" class="new-get-num" style="display:none;"></span>
					</span>
					<span class="new-input-span new-input-span-v1 new-mg-b10">
						<input class="new-input" type="text" id="address" name="address" placeholder="地址" />
						<span  id="second" class="new-get-num" style="display:none;"></span>
					</span>
					<span class="new-input-span new-input-span-v1 new-mg-b10">
						<input class="new-input" type="text" id="phone" name="phone" tabindex="1" placeholder="联系电话"/>
						<span  id="second" class="new-get-num" style="display:none;"></span>
					</span>

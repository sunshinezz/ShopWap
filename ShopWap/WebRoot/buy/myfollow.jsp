...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/favorites.css" charset="gbk"/>	
	...
	<body id="body">
		...
		<div class="new-ct">
			<div class="new-search new-my-att">    	
				<ul class="new-mu_l2w">		
					<div class="mc">
						<div class="tb-void">
						    <script> 
								...
								{
									if(confirm("确定要取消关注此商品吗？"))
									location.href="/ShopWap/buy/myOrderServlet.do?action=cancelFollow&likeId="+id;
							    }
							    function shopcar()
								{ 
							...
							<table border="0" cellspacing="0" cellpadding="0" width="100%">
								...
								<tbody id="follow_table">
									<c:forEach items="${likes }" var ="like">
										<li class="new-mu_l2 new-p-re">
											<a class="new-mu_l2a" href="/ShopWap/items/items.do?id=${like.itemId}">
											<span class="new-mu_tmb"><img src="${like.itemImage }" alt="${like.itemname }" width="100" height="100" /></span>
												<span class="new-mu_l2cw">
													<strong class="new-mu_l2h">${like.itemname }</strong>
													<span class="new-mu_l2c">
													<strong class="new-txt2 new-txt-rd2">&yen;${like.itemprice } </strong>
													</span>
												</span>
											</a>
											<a onclick="cancelFollow(${like.id});" href="#" clstag="click|keycount|follow|cancel" class="new-a-delete"></a> 
										</li>
									</c:forEach>
	...
	jQuery(function(){
		jQuery(".new-a-delete").click(function(){
			var wareId = jQuery(this).attr("did");
			if (confirm("确定要取消该收藏吗？")){
				jQuery.get(
					"/user/cancelFavorite.json",
					{"wareId":wareId,"sid":'85f8ed8aa52280a63bde91ab4c839508'},
				   function(data){
	...
	//	syncCart('85f8ed8aa52280a63bde91ab4c839508',true);
	...
	var depCity = window.sessionStorage.getItem("airline_depCityName");
		if(testSessionStorage() && isNotBlank(depCity) && !/^\s*$/.test(depCity) && depCity!=""){
			...
			+'<input type="hidden" name="sid"  value="85f8ed8aa52280a63bde91ab4c839508"/>'
			...
			window.location.href='/airline/index.action?sid=85f8ed8aa52280a63bde91ab4c839508';
		}
	}
	 //banner 关闭点击

...
<div class="new-ct">
	<div class="new-addr">
		<c:if test="${num==1}">
			<form id="modifyAddr" name="modifyAddr" onsubmit="return false;" method="post" action="/ShopWap/buy/myOrderServlet.do?action=modifyAddr&num=1">
				<div class="new-info-box">
					<div class="new-set-info">
						<span class="new-txt2 new-mg-b5">收货人姓名</span>
						<span class="new-input-span new-mg-b10">
							<input type="text" name="name" id="w_name" maxlength="25" class="new-input" value="${user.name1 }"/>
						</span>
						<span class="new-txt-err"  id="name_error"  ></span>
						<span class="new-txt2 new-mg-b5">手机号码</span>
						<span class="new-span-block new-mg-b10">
							<span class="new-input-span"><input id="phone1" name="phone" value="${user.phone1 }"  class="new-input"/></span>
					...
					<div class="new-ship-addr">
						...
						<div class="new-mg-t10">
							<span class="new-tbl-type new-mg-b10">
								<span class="new-tbl-cell new-txt-w38">地址</span>
								<span class="new-tbl-cell">
									<div class="new-post_wr">
										<textarea name="address" id="w_name" rows="5" cols="30" title="" class="new-textarea" value="${user.address1 }"></textarea>
									</div>
					...
					<a href="javascript:void();"  onclick="check()"  name="order_submit" id="address_submit" class="new-abtn-type new-mg-t15">保存地址</a>
				</div>
			</form>
		</c:if>
		<c:if test="${num==2}">
			<form id="modifyAddr" name="modifyAddr" onsubmit="return false;" method="post" action="/ShopWap/buy/myOrderServlet.do?action=modifyAddr&num=2">
				<div class="new-info-box">
					<div class="new-set-info">
						<span class="new-txt2 new-mg-b5">收货人姓名</span>
						<span class="new-input-span new-mg-b10">
							<input type="text" name="name" id="w_name" maxlength="25" class="new-input" value="${user.name2 }"/>
						</span>
						<span class="new-txt-err"  id="name_error"  ></span>
						<span class="new-txt2 new-mg-b5">手机号码</span>
						<span class="new-span-block new-mg-b10">
							<span class="new-input-span"><input id="phone1" name="phone" value="${user.phone2 }"  class="new-input"/></span>
							<span class="new-txt-err" id="mobile_error"></span>
						</span>
					</div>
					<div class="new-ship-addr">
						...
						<div class="new-mg-t10">
							<span class="new-tbl-type new-mg-b10">
								...
								<span class="new-tbl-cell">
									<div class="new-post_wr">
										<textarea name="address" id="w_name" rows="5" cols="30" title="" class="new-textarea" value="${user.address2 }"></textarea>
									</div>
									 <span class="new-txt-err"	id="where_error"></span>
								</span>                        
							</span>
		...
		<c:if test="${num==3}">
			<form id="modifyAddr" name="modifyAddr" onsubmit="return false;" method="post" action="/ShopWap/buy/myOrderServlet.do?action=modifyAddr&num=3">
				<div class="new-info-box">
					<div class="new-set-info">
						<span class="new-txt2 new-mg-b5">收货人姓名</span>
						<span class="new-input-span new-mg-b10">
							<input type="text" name="name" id="w_name" maxlength="25" class="new-input" value="${user.name3 }"/>
						</span>
						<span class="new-txt-err"  id="name_error"  ></span>
						<span class="new-txt2 new-mg-b5">手机号码</span>
						<span class="new-span-block new-mg-b10">
							<span class="new-input-span"><input id="phone1" name="phone" value="${user.phone3 }"  class="new-input"/></span>
							<span class="new-txt-err" id="mobile_error"></span>
						</span>
					</div>
					<div class="new-ship-addr">
						...
						<div class="new-mg-t10">
							<span class="new-tbl-type new-mg-b10">
								...
								<span class="new-tbl-cell">
									<div class="new-post_wr">
										<textarea name="address" id="w_name" rows="5" cols="30" title="" class="new-textarea" value="${user.address3 }"></textarea>
									</div>
									 <span class="new-txt-err"	id="where_error"></span>
								</span>                        
							</span>
		...
		<c:if test="${num<=0}">
			<form id="modifyAddr" name="modifyAddr" onsubmit="return false;" method="post" action="/ShopWap/buy/myOrderServlet.do?action=modifyAddr&num=-${-num+1 }">
				<div class="new-info-box">
					<div class="new-set-info">
						<span class="new-txt2 new-mg-b5">收货人姓名</span>
						<span class="new-input-span new-mg-b10">
							<input type="text" name="name" id="w_name" maxlength="25" class="new-input" value=""/>
						</span>
						<span class="new-txt-err"  id="name_error"  ></span>
						<span class="new-txt2 new-mg-b5">手机号码</span>
						<span class="new-span-block new-mg-b10">
							<span class="new-input-span"><input id="phone1" name="phone" value=""  class="new-input"/></span>
							<span class="new-txt-err" id="mobile_error"></span>
						</span>
					</div>
					<div class="new-ship-addr">
						...
						<div class="new-mg-t10">
							<span class="new-tbl-type new-mg-b10">
								...
								<span class="new-tbl-cell">
									<div class="new-post_wr">
										<textarea name="address" id="w_name" rows="5" cols="30" title="" class="new-textarea" value=""></textarea>
									</div>
									 <span class="new-txt-err"	id="where_error"></span>
								</span>                        
							</span>

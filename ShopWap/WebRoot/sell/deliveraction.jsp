	...
	<body class="cart list">
		...
		<div class="m" id="m">
			<div class="mc cart-list tl">
				<form name="select" action="/ShopWap/sell/sellaction.do?action=deliveraction" method="post" onsubmit="">
						...
						<li class="first" id="product645456">
							<div class="clear"> 
								<div class="p-img p-img-v1 fl">
									<a href='/ShopWap/items/items.do?id=${order.itemId }' class="pay-img"><img width="50" alt="${order.name}" src="${order.image}"/></a>
								</div>
								<div class="fl fl-v1">
									...
									<p class="p-price2"></p>
									<p class="p-amount">运单号<input type="text" name="waybillid" value=""/></p>
									<p class="p-amount">
										<a href="javascript:submit();" class="btn">发货</a>
									</p>
								</div>  	
							</div>
							<p class="p-price2"></p>

				...
				<c:forEach items="${orderlist}" var="order">
					...
					<div class="clear"> 
						<div class="p-img p-img-v1 fl">
							<a href='/ShopWap/items/items.do?id=${order.itemId }' class="pay-img"><img width="50" alt="${order.itemname}" src="${order.image}"/></a>
						</div>
						<div class="fl fl-v1">
							...
							<p class="p-price2"></p>
							<p class="p-amount">状态:${state}</p>
							<p class="p-amount">操作: &nbsp;&nbsp;&nbsp;
								<a href="sellaction.do?action=yrefund&id=${order.id}" class="btn" clstag="click|keycount|orderinfo|order_check">退款</a>
								<a href="sellaction.do?action=nrefund&id=${order.id}" class="btn" clstag="click|keycount|orderinfo|order_check">拒绝退款</a>
							</p>					
						</div>  	
					</div>
					<p class="p-price2"></p>

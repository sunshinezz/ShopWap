			...
			<ul>
				...
				<c:forEach items="${ilist }" var="list">
					...
					<div class="clear"> 
						...
						<div class="fl fl-v1">
							<p class="p-name">${list.name} </p>
							<p class="p-num gray">${list.id }</p>
							<p class="p-price">${list.saledate }<span class="red"></span></p> 
							<p class="p-num gray">${list.price }</p>
							
							<p class="p-amount">操作: &nbsp;&nbsp;&nbsp;
								
									<a href="adminManage.do?action=verify&id=${list.id}" target="_self" class="btn" clstag="click|keycount|orderinfo|order_check">审核</a>

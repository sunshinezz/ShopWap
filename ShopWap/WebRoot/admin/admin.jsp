...
<html>
	...
	<div class="new-section-lst">
		<ul class="new-lst-ul">
			<li class="new-lst-li">
				<a href='adminManage.do?action=unverify'>
					审核<span class="new-arr"></span>
				</a>
			</li>
			<li class="new-lst-li">
				<a href='adminManage.do?action=item'>
					正常商品列表<span class="new-arr"></span>
				</a>
			</li>
		</ul>
		<ul class="new-lst-ul">
			<li class="new-lst-li">
				<a href='adminManage.do?action=msg' >消息精灵<span class="new-arr"></span></a>
			</li>
		</ul>

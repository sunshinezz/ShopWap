	...
	<div class="new-addr">   
		<ul class="new-mu_l2w">
				<li class="new-mu_l2">
					...
					<span class="new-mu_l2a new-p-re">
						<span class="new-mu_l2cw">			
							状态：<c:if test="${item.state==0 }"> 待审核</c:if>
						</span>    
					</span>				
					<div class="new-addr-btn">
						<a href="/ShopWap/admin/adminManage.do?id=${item.id }&action=yes" ><s></s>通过</a></td>
						<a href="/ShopWap/admin/adminManage.do?id=${item.id }&action=no" ><s></s>不通过</a></td>
					</div>

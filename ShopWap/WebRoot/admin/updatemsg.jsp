...
<header>
		...
		<div class="new-jd-tab" style="display:none" id="jdkey">
			<div class="new-tbl-type">
				...
				<a href="adminManage.do?action=welcome" class="new-tbl-cell">
					<span class="icon4">admin</span>
					<p style="color:#6e6e6e;">admin</p>
				</a>
			</div>
		</div>
	</header>
...
<div class="new-ct">
	<div class="new-addr">
		<form name="userForm" id="updateForm" action="/ShopWap/admin/adminManage.do?action=updatemsg" method="post">
			
				<div class="new-info-box">
					<div class="new-set-info">
						<span class="new-txt2 new-mg-b5">通知编号：</span>
						<span class="new-input-span new-mg-b10">
							<input type="text"  class="new-input" id="name" name="id" value="${msg.id }" readonly/>
						</span>
						<span class="new-txt-err"  id="name_error"  ></span>
						<span class="new-txt2 new-mg-b5">发布时间：</span>
						<span class="new-span-block new-mg-b10">
							<span class="new-input-span"><input id="name" name="time" value="${msg.date }"  class="new-input"/></span>
							<span class="new-txt-err" id="mobile_error"></span>
						</span>
					</div>
					<div class="new-ship-addr">
						<strong class="new-tit">通知内容：</strong>
						
						<div class="new-mg-t10">
							<span class="new-tbl-type new-mg-b10">
								<span class="new-tbl-cell new-txt-w38">通知内容：</span>
								<span class="new-tbl-cell">
									<div class="new-post_wr">
										<textarea name="content" id="info" rows="5" cols="30" title="" class="new-textarea" value="${msg.content }">${msg.content }</textarea>
									</div>
									 <span class="new-txt-err"	id="where_error">
									 </span>
								</span>                        
							</span>
						</div>
					...
					<a href="javascript:fsubmit(document.userForm);" class="new-abtn-type new-mg-t15">保存修改</a>
				</div>
			</form>
	</div>
</div>
	...
	<div class="login-area" id="footer">
		<div class="login">
			<% 
				...
				if(cookie.getName().equals("admin"))	// 如果Cookie名为name
			...
			<% if(login){ %>
				<a href="adminManage.do?action=welcome"> 欢迎您, ${ cookie.admin.value }. </a>&nbsp;&nbsp; <span class="lg-bar">|</span>
				<a href="../admin/admin.do?action=logout">退出</a>
			<% }
				else { %> </a>

				...
				<c:forEach items="${mlist}" var="list">
					<div class="new-msg-section" id="detail">
						...
						<div class="new-addr-btn">
							<a href="adminManage.do?action=toupdatemsg&id=${list.id}" ><s></s>修改</a></td>
							<a href="adminManage.do?action=deletemsg&id=${list.id}" ><s></s>删除</a></td>
						</div>						
					</div>
				</c:forEach> 	
			</div>
		</div>
		<a href="/ShopWap/admin/addmsg.jsp" class="new-abtn-type new-mg-t15">新增</a>

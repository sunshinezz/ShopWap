...
<div class="new-ct">
	<div class="new-addr">
		<form name="userForm" id="updateForm" action="/ShopWap/admin/adminManage.do?action=addmsg" method="post">
			
				<div class="new-info-box">
					<div class="new-ship-addr">
						<strong class="new-tit">消息内容</strong>
						
						<div class="new-mg-t10">
							<span class="new-tbl-type new-mg-b10">
								<span class="new-tbl-cell new-txt-w38">消息内容</span>
					...
					<a href="javascript:fsubmit(document.userForm);" class="new-abtn-type new-mg-t15">提交</a>
				</div>
			</form>
	</div>
</div>

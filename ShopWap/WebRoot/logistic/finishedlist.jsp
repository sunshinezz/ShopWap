			  ...
			  <DIV class="mt">
				...
				<script type="text/javascript" language="javascript">
						 function choose()
						 {
							...
							if(!state.length==0)
							{
								window.location.href="/ShopWap/buy/myOrderServlet.do?state="+state;
							}
				...
				<ul>
				  <TABLE border="0" cellSpacing="0" cellPadding="0" width="100%">
				   ...
				   <li class="first" id="product645456">
						...
						<p class="p-price2">运单号：<span class="ftx-03">${list.id }</span></p>
				
						<p class="p-price2">生成时间：<span class="ftx-03">${list.cDate }</span></p>
						<p class="p-price2">完成时间：<span class="ftx-03">${list.eDate }</span></p>
						<p class="p-amount">状态:<SPAN class="ftx-03">已完成<BR />
								  </SPAN>
						...
						<p class="p-amount">操作: &nbsp;&nbsp;&nbsp;
							...
							<A href="logManage.do?action=finishedshow&id=${list.id}" class="btn" target="_blank" clstag="click|keycount|orderinfo|order_check">查看</A>

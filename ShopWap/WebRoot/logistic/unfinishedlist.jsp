				  ...
				  <TABLE border="0" cellSpacing="0" cellPadding="0" width="100%">
				   ...
				   <c:forEach items="${loglist }" var="list">
				      ...
				      <li class="first" id="product645456">
						...
						<p class="p-price2">更新时间：<span class="ftx-03">${list.eDate }</span></p>
						<p class="p-amount">状态:<SPAN class="ftx-03">未完成<BR />
								  </SPAN>
						...
						<p class="p-amount">操作: &nbsp;&nbsp;&nbsp;
							...
							<A href="logManage.do?action=unfinishedshow&id=${list.id}" class="btn" target="_blank" clstag="click|keycount|orderinfo|order_check">更新</A>
